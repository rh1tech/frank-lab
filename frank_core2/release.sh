#!/usr/bin/env bash
#
# release.sh - Automate a frank_core2 hardware release.
#
...
# Basename used for the published artifacts ("dino_1_00.zip", ...).
# Defaults to the project name; override to publish under another name.
