...
#
# build.sh — build the FRANK Core 2 slave firmware (RP2350, U6).
#
# Env vars:
#   USB_HID      0 = USB CDC console on J9 (default, best for bring-up)
#                1 = console on UART1 (J4 header, GPIO24/25)
...
echo
echo "Slave firmware:  $(pwd)/build/frank-core2-slave.uf2"
